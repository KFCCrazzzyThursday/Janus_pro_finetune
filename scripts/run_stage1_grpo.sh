...
export JANUS_JUDGE_BATCH_SIZE="${JANUS_JUDGE_BATCH_SIZE:-4}"
export JANUS_JUDGE_CONCURRENCY="${JANUS_JUDGE_CONCURRENCY:-16}"
export JANUS_JUDGE_COMPACT_PROMPT="${JANUS_JUDGE_COMPACT_PROMPT:-1}"
export JANUS_JUDGE_MAX_REASONING_CHARS="${JANUS_JUDGE_MAX_REASONING_CHARS:-2048}"
export JANUS_JUDGE_SAMPLE_FRACTION="${JANUS_JUDGE_SAMPLE_FRACTION:-0.5}"
export JANUS_JUDGE_ACTIVATION_THRESHOLD="${JANUS_JUDGE_ACTIVATION_THRESHOLD:-0.625}"
...
export JANUS_JUDGE_PIPELINE="${JANUS_JUDGE_PIPELINE:-0}"
